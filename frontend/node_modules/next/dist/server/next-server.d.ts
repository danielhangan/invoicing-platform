...
import type { Params, Route } from 'next/dist/server/router';
...
import type { ParsedNextUrl } from 'next/dist/shared/lib/router/utils/parse-next-url';
...
import BaseServer, { Options, FindComponentsResult } from 'next/dist/server/base-server';
...
export default class NextNodeServer extends BaseServer {
    ...
    protected getMiddlewareInfo(page: string): {
        ...
        paths: string[];
        env: string[];
        wasm: import("next/dist/build/webpack/loaders/get-module-build-info").WasmBinding[];
    };
